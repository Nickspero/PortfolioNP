...
const page = () => {
  return (
    <div className="w-full">
      <div className="max-w-[1600px] mx-auto p-6 flex flex-col gap-8">
        ...
        <div className="flex">
          <div className="text max-w-[50%]">
            ...
            <p className="text-[24px] mt-[40px]">
              My approach combines clean, efficient code with a strong focus on
              UI/UX, ensuring every interaction is{" "}
        ...
        <div className="w-full p-6 bg-[#3bbad8]">
          ...
          <div className="grid grid-cols-5 justify-items-center gap-6">
            ...
            <figure className="tech">
              <img className="tech__logo" src="/next_transparent.png" alt="" />
